    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">E-Commerce & Retail Solutions</h2>
          <p className="text-gray-600 mb-6">Scalable platforms and solutions for online retail businesses</p>
