              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <a
                    ...
                    className="group relative overflow-hidden bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 fade-in-up"
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mt-4 flex items-center justify-center">
                        <span className="text-xs bg-white/20 px-3 py-1 rounded-full group-hover:bg-white/30 transition-colors">
                          Follow →
                        </span>
                      </div>
                    </div>
                  ...
                  {/* LinkedIn Card */}
                  <a
                    href="https://www.linkedin.com/company/adysunventures/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 fade-in-up"
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-center mb-2">Follow us on LinkedIn</h3>
                      <p className="text-sm text-white/90 text-center">Connect with our professional network</p>
                      <div className="mt-4 flex items-center justify-center">
                        <span className="text-xs bg-white/20 px-3 py-1 rounded-full group-hover:bg-white/30 transition-colors">
                          Follow →
                        </span>
